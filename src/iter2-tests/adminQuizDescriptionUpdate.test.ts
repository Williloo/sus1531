import {
  ...
  describe('tests for adminQuizDescriptionUpdate', () => {
    ...
    beforeEach(() => {
      clear()
      const registerResult = adminAuthRegister('hayden.smith@unsw.edu.au', 'myPassword1', 'Hayden', 'Smith')
    ...
    describe('Error cases', () => {
      ...
      test('trying to update description of a quiz that is not owned by an user will return error', () => {
        ...
        const otherQuizResult = adminQuizCreate(otherSessionToken, 'Other Quiz', 'Other description')
